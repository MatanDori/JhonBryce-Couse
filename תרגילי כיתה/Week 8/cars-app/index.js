...
let allCars = carsForRental.concat(carsForSale)
...
function init() {
    ...
    document.getElementById("AddSpecificCar")?.addEventListener("click", function () {
        // loadTable([...carsForRental, ...carsForSale])
        NewCar()
    })
}
function NewCar(){
    let car ={
        ...
        Miles_per_Gallon: document.getElementById("mpg"),
        ...
        Weight_in_lbs: document.getElementById("weight"),
